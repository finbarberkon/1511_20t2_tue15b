...
int main(void) {
   ...
   *    until end of input / end of file (EOF) */
  /* 2) modify this loop to save the numbers into an array (and make
   *    sure to initialise this array!) */
   ...
   *    that number. What about the first and last? */
  return 0;
}
